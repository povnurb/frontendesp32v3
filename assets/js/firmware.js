...
export async function iniciarFirmware(){
                ...
                children: [
                    {
                        type: 'strong', 
                        props: {}, 
                        children: ['Nota: Use este Botón para exportar las configuraciones actuales del dispositivo']
                    }
                ]
            },
            {
    ...
    */
    ...
    const downloadObjectAsJson = (exportObj, filename)=>{
        ...
        link.dataset.downloadurl = ["text/json", link.download, link.href].join(":"); //captura donde se va a guardar
