...
export async function iniciarFirmware() {
  ...
  document.title = "Firmware & Settings";
  // Creamos el breadcrum
  createBreadCrumb(
    "Configuración del Firmware y Settings",
    "Dispositivo",
    "Firmware & Settings"
  );
    ...
    children: [
      {
        ...
        children: [
          "Use este Botón para actualizar el Firmware o el FileSystem del Dispositivo.",
        ],
      },
      {
        type: "div",
            ...
            children: [
              {
                ...
                props: {
                  ...
                  type: "file",
                  id: "fileFirmware",
                  accept: "application/octet-stream", //para solo aceptar archivos binarios
                },
                children: [],
              },
            ],
            ...
            children: [
              {
                ...
                props: {},
                children: [
                  "Nota: Si el nombre de archivo incluye (spiffs), actualiza la partición del FileSystem",
                ],
              },
            ],
          },
            ...
            children: [
              {
                ...
                props: {
                  class:
                    "progress-bar progress-bar-striped bg-secondary progress-bar-animated",
                  style: "width: 0%",
                  id: "progressFirmware",
                },
                children: ["0"],
      ...
      },
      {
        ...
        children: [
            ...
            children: [
              {
                ...
                props: {
                  ...
                  type: "file",
                  id: "fileSettings",
                  accept: "application/json", //solo para este tipo de archivos
                },
                children: [],
              },
            ],
          },
          {
            ...
            props: { class: "col-sm-12 col-form-label", for: "fileSettings" },
            children: [
              "Nota: Por seguridad, para actualizar fecha y hora, es necesario oprimir el boton D33 mientras se reinicia el dispositivo.",
            ],
          },
        ],
      },
        ...
        children: [
          {
            ...
            props: {},
            children: [
              "Nota: Use este Botón para exportar las configuraciones actuales del dispositivo",
            ],
          },
        ],
      },
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              new card(
                "Archivo de configuración (setting.json)",
                inputsSettings
              ).buildCard(),
            ],
          },
  ...
  const uploadFirmware = async () => {
    ...
    if (file != undefined) {
      ...
      if (Number(file["size"]) > 1966080) {
        SweetAlertMsg(
          "top-end",
          "error",
          "¡El tamaño máximo del archivo tiene que ser de ( 1.9 MB )!",
          5000
        );
        return;
        ...
        SweetAlertMsg(
          "top-end",
          "error",
          "¡Solo son permitidos archivos ( *.BIN )!",
          5000
        );
        return;
      } else {
      ...
      SweetAlertMsg(
        "top-end",
        "warning",
        "¡Debes seleccionar un archivo( *.BIN )!",
        5000
      );
      return;
    }
    ...
    console.log(resp);
    if (resp["save"]) {
      // se modificar a resp["save"] y si jala antes resp.save
      SweetAlertMsg(
        "top-end",
        "success",
        `¡${resp.type} actualizado correctamente!`,
        5000
      );
  ...
  const settingDonwload = async () => {
    //es asincrona por que va hacer una peticion a la api
    ...
    if (file != undefined) {
      if (file["name"] != "settings.json") {
        SweetAlertMsg(
          "top-end",
          "error",
          "¡Solo se permite el archivo de configuración ( settings.json )!",
          5000
        );
        return;
        ...
        SweetAlertMsg(
          "top-end",
          "error",
          "¡El tamaño máximo permitido es de ( 14.0 KB )!",
          5000
        );
        return;
        ...
        SweetAlertMsg(
          "top-end",
          "error",
          "¡Solo son permitidos archivos ( *.JSON )!",
          5000
        );
        return;
      } else {
      ...
      SweetAlertMsg(
        "top-end",
        "warning",
        "¡Debes seleccionar un archivo ( *.JSON )!",
        5000
      );
      return;
    }
